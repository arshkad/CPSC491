...
#     # Calculate contrast between features (more detailed)
#     contrast_skin_hair = calculate_contrast(skin_rgb, hair_rgb)
#     contrast_skin_eye = calculate_contrast(skin_rgb, eye_rgb)
...
#     # Hair darkness factor (very dark hair often indicates winter/autumn)
#     hair_is_dark = hair_brightness < 0.3
#     hair_is_light = hair_brightness > 0.6
...
#     is_warm = combined_warm > 0.02  # Lowered threshold for more sensitivity
#     is_cool = combined_warm < -0.02
#     is_neutral = not is_warm and not is_cool
    
#     # High contrast: significant difference between skin/hair/eyes
#     is_high_contrast = overall_contrast > 0.25  # Lowered threshold
#     is_low_contrast = overall_contrast < 0.15
    
#     # Brightness and clarity
#     is_bright_clear = avg_saturation > 0.35 and skin_brightness > 0.55
#     is_muted_soft = avg_saturation < 0.25 or (skin_brightness < 0.45)
    
#     # Refined season determination with more cases
#     if is_warm or (is_neutral and combined_warm > -0.01):
#         # Warm or warm-neutral
#         if is_high_contrast and is_bright_clear:
#             # Warm + High Contrast + Bright = Spring
#             return "Spring"
#         elif hair_is_dark and is_high_contrast:
#             # Warm + Dark hair + High contrast = Could be Autumn
#             return "Autumn"
#         elif is_muted_soft or (not is_bright_clear):
#             # Warm + Muted/Soft = Autumn
#             return "Autumn"
#         else:
#             # Default warm with moderate features = Spring
#             return "Spring"
#     else:
#         # Cool or cool-neutral
#         if is_high_contrast and is_bright_clear:
#             # Cool + High Contrast + Bright = Winter
#             return "Winter"
#         elif hair_is_dark and is_high_contrast and not is_muted_soft:
#             # Cool + Dark hair + High contrast + Clear = Winter
#             return "Winter"
#         elif is_low_contrast or is_muted_soft:
#             # Cool + Low contrast or Muted = Summer
#             return "Summer"
#         elif hair_is_light and eye_is_light:
#             # Cool + Light hair + Light eyes = Summer
#             return "Summer"
#         else:
#             # Default cool with moderate features = Summer
#             return "Summer"
